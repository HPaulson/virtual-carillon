...
export const christIsMadeTheSureFoundation = defineHymn({
  ...
  source:
    'John Mason Neale translation of the traditional Latin Angularis fundamentum; WESTMINSTER ABBEY tune',
  sourceUrl: 'https://hymnary.org/text/christ_is_made_the_sure_foundation',
  license:
    'Public-domain text and melody; source tune record and transcription credited in this asset',
  liturgical: {
