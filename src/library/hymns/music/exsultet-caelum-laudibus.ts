...
export const exsultetCaelumLaudibus = defineHymn({
  ...
  source:
    'Traditional Latin office hymn, Gregorian chant Mode I for Vespers in the Common of Apostles',
  sourceUrl:
    'https://www2.divinumofficium.com/cgi-bin/horas/Pofficium.pl?command=prayVesperae&date1=11-11-2024&lang2=Latin-gabc&version=Monastic+-+1963&votive=C1',
