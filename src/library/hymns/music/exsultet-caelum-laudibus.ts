...
export const exsultetCaelumLaudibus = defineHymn({
  id: 'exsultet-caelum-laudibus',
  name: 'Exsultet Caelum Laudibus (Common of Apostles)',
  source: 'Traditional Latin office hymn, Gregorian chant Mode I for Vespers in the Common of Apostles',
  sourceUrl: 'https://www2.divinumofficium.com/cgi-bin/horas/Pofficium.pl?command=prayVesperae&date1=11-11-2024&lang2=Latin-gabc&version=Monastic+-+1963&votive=C1',
  license: 'Public-domain Gregorian hymn; breviary source and transcription credited in this asset',
  tags: ['Hymn', 'Gregorian', 'Apostles', 'Vespers'],
  liturgical: { categories: ['apostles', 'saints'], seasons: ['General', 'Ordinary Time'], offices: ['Vespers'], feasts: [], solemnities: [] },
  notation: melody({
    meter: { numerator: 1, denominator: 1 }, unitLength: 'sixteenth', key: 'D', tempo: 72, mode: 1, rhythmicCharacter: 'free',
    measures: [
      measure([note('D4', 'quarter'), note('E4', 'quarter'), note('F4', 'quarter'), note('A4', 'quarter')]),
