...
export const exsultetOrbisGaudiis = defineHymn({
  ...
  source: 'Traditional Latin hymn, Gregorian chant for the Common of Apostles',
  sourceUrl:
  ...
  notation: melody({
    ...
    measures: [
      ...
      measure([note('C5', 'quarter'), note('B4', 'quarter'), note('A4', 'quarter'), note('G4', 'quarter')]),
      ...
      measure([note('G4', 'quarter'), note('A4', 'quarter'), note('C5', 'half')]),
      measure([note('D5', 'quarter'), note('C5', 'quarter'), note('B4', 'quarter'), note('A4', 'quarter')]),
      ...
      measure([note('A4', 'quarter'), note('B4', 'quarter'), note('C5', 'quarter'), note('D5', 'quarter')]),
