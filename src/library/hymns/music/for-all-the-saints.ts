...
export const forAllTheSaints = defineHymn({
  ...
  notation: melody({
    ...
    measures: [
      measure([note('D4', 'quarter'), note('B4', 'quarter'), note('A4', 'quarter'), note('G4', 'half')]),
      measure([note('D4', 'quarter'), note('E4', 'quarter'), note('G4', 'quarter'), note('A4', 'quarter')]),
      ...
      measure([note('A4', 'quarter'), note('F#4', 'quarter'), note('E4', 'quarter'), note('D4', 'quarter')]),
      measure([note('G4', 'whole')]),
      measure([note('G4', 'quarter'), note('G4', 'quarter'), note('D5', 'half')]),
      measure([note('D5', 'quarter'), note('C5', 'eighth'), note('B4', 'eighth'), note('A4', 'quarter'), note('G4', 'quarter')]),
      measure([note('A4', 'half'), note('D5', 'half')]),
      measure([note('E5', 'quarter'), note('D5', 'eighth'), note('C5', 'eighth'), note('D5', 'half')]),
