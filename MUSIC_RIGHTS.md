...
1. The underlying melody is identified as public domain, either because it is
   traditional/anonymous or because the named composer died before 1956.
...
before 1931 are public domain. For conservative international publication, this
review also excludes composers who died in 1956 or later. Gregorian and other
medieval chant is anonymous/traditional; no modern editor, edition, or
translation is included. GregoBase additionally publishes its chant
...
| `for-all-the-saints`                                              | Ralph Vaughan Williams (1958)                     | REMOVE             | Not public domain internationally until 2029 |
...
## Removed from the release catalog

`for-all-the-saints` is not distributed in the public release. Its melody,
SINE NOMINE, was written by Ralph Vaughan Williams (d. 1958). It is public
domain in the United States because of its 1906 publication, but not yet under
the conservative life-plus-70 international rule used here. The source, test
fixture, and documentation references are removed with the release cleanup.
